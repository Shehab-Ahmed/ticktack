<template>
    <main class="auth-wrapper">
        <form class="auth-form" @submit.prevent="handleSubmit">
            ...
            <h2 class="h3 mb-4 fw-normal">{{ $t('register.titlePage') }}</h2>
            <div class="form-floating mb-2">
                <input type="text" class="form-control" :class="{ 'is-invalid': errors.name && errors.name[0] }" id="name" v-model="form.name" placeholder="{{ $t('register.placName') }}" />
            ...
            <div class="form-floating mb-3">
                <input type="password" class="form-control" :class="{ 'is-invalid': errors.password && errors.password[0] }" id="password" v-model="form.password" placeholder="{{ $t('register.password') }}" />
            ...
            <div class="form-floating mb-3">
                ...
                <label for="password_confirmation">{{ $t('register.passConf') }}</label>
            </div>
            <button class="w-100 btn btn-lg btn-primary" type="submit">{{ $t('register.signup') }}</button>
        </form>
    </main>
</template>
