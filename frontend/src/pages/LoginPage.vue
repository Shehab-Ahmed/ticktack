<template>
    <main class="auth-wrapper">
        <form class="auth-form container" @submit.prevent="handleSubmit">
            <h1>
                <strong>{{ $t('main.name') }}</strong>
            </h1>
            <h2 class="h3 mb-4 fw-normal">{{ $t('login.titlePage') }}</h2>
            ...
            <button class="w-100 btn btn-lg btn-primary" type="submit">{{ $t('login.signin') }}</button>
        </form>
    </main>
</template>
